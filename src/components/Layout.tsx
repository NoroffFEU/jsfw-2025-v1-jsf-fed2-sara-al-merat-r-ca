    ...
    <div className="min-h-screen flex flex-col bg-[#f8f5e6] font-serif text-gray-800">
      ...
      <header className="bg-indigo-900 text-[#f8f5e6] border-b-4 border-indigo-700/50 border-dashed shadow-sm relative overflow-hidden">
        ...
        <nav
          ...
          className="container mx-auto px-6 py-6 flex justify-between items-center relative z-10">
          <Link
            to="/"
            aria-label="Aurora Shop homepage"
            className="text-3xl font-black tracking-tight hover:text-orange-200 transition-colors">
            Aurora Shop.
          </Link>
